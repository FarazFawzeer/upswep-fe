...
{{-- ============================================================
     ...
     Structure: Header (partial) -> Breadcrumb -> Page title+intro
     -> 2-column: Contact form (left) | Store info + map (right)
     -> Footer (partial)

     Same pattern as index.blade.php / grid.blade.php / product.blade.php:
     global header/nav/footer/tokens/buttons come from the layout +
     partials, only contact-page-specific markup + CSS live here.

     Form posts to a placeholder route for now — wire it to a real
     controller once ready, e.g.:
     Route::post('/contact', [ContactController::class, 'store'])->name('contact.store');
     and save submissions to a simple `contact_messages` table,
     following the same enquiry-only pattern as the product page
     (no live chat, no auto-reply — dealer follows up manually).
============================================================ --}}
