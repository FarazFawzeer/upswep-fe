...
@section('title', 'UPSWEP CLOHING LINE ')

@section('content')

    {{-- ============================================================
     UPSWEP HOMEPAGE
     Structure: Topbar -> Nav -> Hero -> Category circles ->
     Trending grid -> Styled-for-you strip -> Featured grid ->
     Category circles (workwear) -> Brand showcase -> Footer
     All styles/scripts scoped to this page via @push
============================================================ --}}
