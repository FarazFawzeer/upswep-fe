...
<div class="upswep-home upswep-plp">
    ...
    <div class="up-filter-bar">
        <div class="up-container">
            ...
            <p class="up-filter-bar__count" id="up-result-count">Showing <?php echo e(count($products)); ?> products</p>
        </div>
    </div>
        ...
        <div class="up-container">
            ...
            <div class="up-product-grid">
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(url('/product')); ?>" class="up-product-card">
                        <div class="up-product-card__img">
                            <img src="<?php echo e(is_array($product) ? $product['img'] : $product->images->first()?->image_path); ?>"
                                alt="<?php echo e(is_array($product) ? $product['name'] : $product->name); ?>">
                        ...
                        <div class="up-product-card__body">
                            <span class="up-product-card__brand"><?php echo e(is_array($product) ? $product['brand'] : $product->brand?->name); ?></span>
                            <span class="up-product-card__name"><?php echo e(is_array($product) ? $product['name'] : $product->name); ?></span>
                            <span class="up-product-card__price">£<?php echo e(number_format(is_array($product) ? $product['price'] : $product->price, 2)); ?></span>
                        </div>
                    </a>
            ...
            <div class="up-pagination">
                <?php if(is_object($products) && method_exists($products, 'links')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Upswep\upswep-fe\resources\views/frontend/grid.blade.php ENDPATH**/ ?>